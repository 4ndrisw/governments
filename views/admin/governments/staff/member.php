...
<div id="wrapper">
    <div class="content">
        <?php if (isset($member)) { ?>
        <?php $this->load->view('admin/governments/staff/stats'); ?>
        <div class="member">
                    ...
                    <div class="panel-body ">
                        ...
                        <div class="tab-content tw-mt-5">
                            ...
                            <div role="tabpanel" class="tab-pane" id="staff_permissions">
                                <?php
                        hooks()->do_action('government_render_permissions');
                        
                        foreach ($roles as $key => $role) {
                            if (get_option('default_government_role') !== $role['roleid']) {
                                unset($roles[$key]);
                            }
                        }
                        ...
                        foreach ($roles as $role) {
                            if (isset($member)) {
                                ...
                                $default_government_role = get_option('default_government_role');
                                if ($default_government_role == $role['roleid']) {
                                    $selected = $role['roleid'];
                                }
                            }
                        }
                        ?>
                                ...
                                <?php
                                     ...
                                     $this->load->view('admin/governments/staff/permissions', $permissionsData);
                                 ?>
                            </div>
                        </div>
                    </div>
